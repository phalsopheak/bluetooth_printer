...
import 'package:printer_bluetooth/src/pos_print_result.dart';
import 'package:printer_bluetooth/src/printer_bluetooth_manager.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<List<int>> demoReceipt(
    ...
    //bytes += ticket.setGlobalCodeTable('RK1048');
    ...
    Uint8List change = await CharsetConverter.encode('UTF-8', 'ប្រាក់អាប់');
    bytes += ticket.textEncoded(change, styles: PosStyles(codeTable: 'CP1257'));
  ...
  Future<List<int>> testTicket(
    ...
    // Unable to determine Pos_Code_Table
    ...
    // bytes += ticket.imageRaster(image, imageFn: PosImageFn.graphics);
